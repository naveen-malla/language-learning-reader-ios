...
/// Provides dictionary lookups using a SQLite database.
/// This provider is thread-safe for concurrent reads using a prepared statement.
final class SQLiteDictionaryProvider: DictionaryProvider {
    ...
    func lookup(normalizedKey: String) -> String? {
        ...
        return queue.sync {
            ...
            // Use SQLITE_TRANSIENT to let SQLite make a copy of the string
